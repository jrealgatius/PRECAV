...
* Recalcular de las estimaciones de los OR y errores estandar teniendo naturaleza apareada del estudio.
...
## 3.2. Perfiles de riesgo según REGICOR antes del primer evento cardiovascular en población mayor (Old:M>=65/F>=65)
...
## 3.4 Modelos uni-multivariantes (Poblacion joven)
