...
fitxer_conductor_cataleg<-"cataleg_definitiu 19.2.19_def.xls"
...
farmacs_dispensats<-agregar_facturacio(dt=FX.FACTURATS,prefix = "FD.",bd.dindex =bdades_index,finestra.dies=c(-365,-30),dt.agregadors=CATALEG)
rm(FX.FACTURATS)
