...
variables_generades %>% full_join(conductor_variables,by="camp")

nou_fitxer<-conductor_variables %>% select(2) %>% left_join(conductor_variables)


BDTOTAL<-readRDS(fitxersortida)
