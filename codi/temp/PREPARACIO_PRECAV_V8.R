...
M2.reg.vars.ls$taula_OR

# Test clogit 

extreure_OR("event~sexe+edat+ANT1_3.E10 + ANT1_3.E11",dades=dades)

res.clogit<-clogit(event ~ sexe + edat + ANT1_3.E10 + ANT1_3.E11 + strata(caseid),data=dades)
