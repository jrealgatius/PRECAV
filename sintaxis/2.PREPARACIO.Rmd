...
flow_chart<-criteris_exclusio_diagrama(dt=dades,taulavariables = conductor_variables,criteris = "c_exclusio1",etiquetes = "exc_lab",grups = "event",ordre="exc_ordre",sequencial=T,pob_lab=c("Pob aparellada nascuda: 1935-1981","Pob final"))
