...
farmacs_dispensats_tot<-agregar_facturacio(dt=FX.FACTURATS,prefix = "FD.",bd.dindex ="20161231",finestra.dies=c(-365,0),dt.agregadors=CATALEG,camp_agregador="agr")
...
farmacs_prescrits_tot<-agregar_prescripcions(dt=FX.PRESCRITS,bd.dindex="20161231",dt.agregadors=CATALEG,prefix="FP.",finestra.dies = c(-1,+1),camp_agregador="agr")
